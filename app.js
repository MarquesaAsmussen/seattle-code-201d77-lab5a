...
function multiplyArray(multArr) { //eslint-disable-line
  let productFirstTwo = multiply(multArr[0], multArr[1])[0];
  let totalProduct = multiply(productFirstTwo, multArr[2])[0];
  let string = `The numbers ${testArray} have a product of ${totalProduct}.`;
